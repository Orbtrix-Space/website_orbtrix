      ...
      <div className="max-w-7xl 2xl:max-w-[1800px] mx-auto px-5 md:px-8 xl:px-12 2xl:px-24 py-10 md:py-14 xl:py-20">
                ...
                <div className="p-6 2xl:p-8 flex items-start justify-between">
                  ...
                  {member.linkedin && (
                    <a
                      ...
                      className="text-neutral-700 hover:text-[var(--neon-cyan)] transition-colors"
        ...
        <div className="mt-14 grid grid-cols-1 lg:grid-cols-2 gap-12 pt-12">
          ...
          <ScrollReveal delay={0.1} glow="teal">
            <div>
              <span className="font-mono text-[11px] uppercase tracking-[0.3em] text-[var(--neon-cyan)] opacity-50 block mb-6 flex items-center gap-3">
                <span className="w-5 h-px bg-[var(--neon-cyan)]" />
                Company
              </span>
              <div className="neon-edge">
                {[
                  ...
                  <div key={idx} className="flex justify-between border-b border-[var(--neon-cyan)]/5 last:border-0 py-4 px-8 2xl:px-10">
        ...
        <ScrollReveal>
          <div className="mt-14 pt-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-7 py-3.5 neon-edge text-white text-base font-medium hover:bg-[var(--neon-cyan)]/5 transition-all duration-300 flex-shrink-0 font-display uppercase"
            >
              View Open Roles
            </a>
          </div>
