  ...
  return (
    <div className="scan-lines">
      ...
      <section className="relative overflow-hidden py-16 md:py-24 xl:py-32 2xl:py-32 px-5 md:px-8 xl:px-12 2xl:px-24 min-h-[70vh] flex items-center">
        ...
        <div className="absolute top-1/3 -left-32 w-[500px] h-[500px] bg-[var(--neon-cyan)] rounded-full opacity-[0.03] blur-[150px] pointer-events-none" />
        <div className="absolute bottom-0 -right-32 w-[400px] h-[400px] bg-[var(--neon-purple)] rounded-full opacity-[0.025] blur-[150px] pointer-events-none" />
        ...
        <div className="max-w-7xl 2xl:max-w-[1800px] mx-auto relative z-10 w-full">
          ...
          >
            ...
            <span className="font-mono text-[11px] uppercase tracking-[0.3em] text-[var(--neon-cyan)] opacity-70">
          ...
          <motion.p
            className="text-base font-mono text-[var(--neon-cyan)] opacity-40 mb-8 uppercase tracking-wider"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 neon-edge text-sm font-mono uppercase tracking-wider text-[var(--neon-cyan)] opacity-70">
            ...
            {PLATFORM_PILLARS.map((pillar, idx) => (
              <ScrollReveal key={idx} delay={idx * 0.1} glow="indigo">
                <div className="neon-edge p-8 2xl:p-12 h-full hover-lift">
                  <pillar.icon className="w-7 h-7 text-[var(--neon-cyan)] opacity-60 mb-4" />
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    <div className="lg:col-span-3">
                      <div className="flex items-center gap-3 mb-5">
                        <div className="w-12 h-12 border border-[var(--neon-cyan)]/20 flex items-center justify-center">
                          <feature.icon className="w-6 h-6 text-[var(--neon-cyan)] opacity-60" />
                        </div>
                    ...
                    <div className="lg:col-span-2 border-t lg:border-t-0 lg:border-l border-[var(--neon-cyan)]/8 pt-6 lg:pt-0 lg:pl-8">
                      ...
                      <div className="space-y-3">
                        {feature.details.map((detail, didx) => (
                          ...
                          >
                            <span className="w-1 h-1 rounded-full bg-[var(--neon-cyan)] opacity-50 mt-2 flex-shrink-0" />
          ...
          <ScrollReveal glow="indigo">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              <div className="neon-edge p-10 2xl:p-14 text-center hover-lift">
                <div className="text-[var(--neon-cyan)] opacity-50 mb-3 flex justify-center">
              ...
              <div className="flex flex-col items-center gap-3 py-4">
                <div className="w-full h-px bg-gradient-to-r from-transparent via-[var(--neon-cyan)]/20 to-transparent" />
                <span className="font-mono text-[10px] text-[var(--neon-cyan)] opacity-40 uppercase tracking-widest">
                  Data Flow
                </span>
                <div className="w-full h-px bg-gradient-to-r from-transparent via-[var(--neon-cyan)]/20 to-transparent" />
              </div>
      ...
      <section className="py-16 md:py-24 2xl:py-32 px-5 md:px-8 xl:px-12 2xl:px-24">
        <ScrollReveal glow="indigo">
          <div className="max-w-7xl 2xl:max-w-[1800px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <Link
              href="/contact"
              className="group px-7 py-3.5 bg-[var(--neon-cyan)] text-white text-base font-semibold hover:bg-[var(--neon-cyan)]/80 transition-all duration-300 flex items-center gap-2 flex-shrink-0 font-display uppercase tracking-wide"
            >
              Request a Demo
