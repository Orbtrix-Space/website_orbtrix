      ...
      <div className="max-w-7xl 2xl:max-w-[1800px] mx-auto px-5 md:px-8 xl:px-12 2xl:px-24 py-10 md:py-14 xl:py-20">
        ...
        <div className="space-y-12">
          {PRODUCTS.map((product, idx) => (
            <ScrollReveal key={product.id} delay={idx * 0.1} glow={idx === 0 ? "indigo" : "teal"}>
              <div className={`${idx === 0 ? "neon-edge" : "neon-edge-purple"} p-10 md:p-12 xl:p-14 2xl:p-16 hover-lift`}>
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10 2xl:gap-8">
                  {/* Left: Info */}
                  <div className="lg:col-span-3">
                    <span
                      className={`font-mono text-[11px] uppercase tracking-[0.3em] block mb-4 flex items-center gap-2 opacity-50 ${
                        idx === 0 ? "text-[var(--neon-cyan)]" : "text-[var(--neon-purple)]"
                      }`}
                    >
                      <span className={`w-1.5 h-1.5 rounded-full pulse-dot ${
                        idx === 0 ? "bg-[var(--neon-cyan)]" : "bg-[var(--neon-purple)]"
                      } opacity-60`} />
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {idx === 0 && (
                        <Link
                          href="/products/disha"
                          className="group inline-flex items-center gap-1.5 text-base text-[var(--neon-cyan)] opacity-60 hover:opacity-100 transition-opacity font-mono"
                        >
                          View full details
                  ...
                  <div className={`lg:col-span-2 border-t lg:border-t-0 lg:border-l pt-8 lg:pt-0 lg:pl-10 ${
                    idx === 0 ? "border-[var(--neon-cyan)]/10" : "border-[var(--neon-purple)]/10"
                  }`}>
        ...
        <ScrollReveal glow="indigo">
          <div className="mt-14 pt-14">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 2xl:gap-8 items-center text-center">
              <div className="neon-edge p-10 2xl:p-16 hover-lift">
                <div className="text-3xl font-bold font-display mb-2 neon-text-cyan">DISHA</div>
                <div className="text-[11px] font-mono uppercase tracking-widest text-neutral-600 mb-3">
                  Ground Segment
                </div>
                <p className="text-base text-neutral-500">
                  Command, telemetry, AI-driven operations
                </p>
              </div>
              ...
              <div className="neon-edge-purple p-10 2xl:p-16 hover-lift">
                <div className="text-3xl font-bold font-display mb-2 neon-text-purple">
                  Rigel OS
                </div>
                <div className="text-[11px] font-mono uppercase tracking-widest text-neutral-600 mb-3">
                  Space Segment
                ...
                <p className="text-base text-neutral-500">
                  Autonomous GNC, mission logic, onboard execution
                </p>
              </div>
            </div>
          </div>
